      ...
      <div class="recommendation-section">
        ...
        <div class="main-content-box">
          ...
          <div class="postcode-section">
            ...
            <p v-if="postcodeError" class="error-text">Postcode must start with 3, be 4 digits, and between 3000-3338</p>
          </div>
...
const validatePostcode = () => {
  ...
  postcodeError.value = !(postcode.value.length === 4 && postcode.value.startsWith('3') && postcodeNumber >= 3000 && postcodeNumber <= 3338);
};
